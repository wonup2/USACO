...
public class rental1 {
	public static void main(String[] args) throws IOException {
		...
		sort(milkProduced);   System.out.println("milkProduced "+ Arrays.toString(milkProduced));  //
		...
		Arrays.sort(shops); System.out.println("shops "+ Arrays.toString(shops));  //
		...
		System.out.println("maxProfit "+ Arrays.toString(maxProfit));  //
